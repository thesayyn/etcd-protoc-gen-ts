...
export class FeatureSet extends pb_1.Message {
    ...
    constructor(data?: any[] | {
        ...
        string_field_validation?: FeatureSetStringFieldValidation;
    ...
    get string_field_validation() {
        return pb_1.Message.getFieldWithDefault(this, 4, FeatureSetStringFieldValidation.STRING_FIELD_VALIDATION_UNKNOWN) as FeatureSetStringFieldValidation;
    }
    set string_field_validation(value: FeatureSetStringFieldValidation) {
        pb_1.Message.setField(this, 4, value);
    }
...
export enum FeatureSetStringFieldValidation {
